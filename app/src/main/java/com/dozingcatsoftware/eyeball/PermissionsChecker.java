...
public class PermissionsChecker {
    ...
    public static final int STORAGE_FOR_CONVERT_PICTURE_REQUEST_CODE = 1004;
    public static final int RECORD_AUDIO_FOR_VIDEO_REQUEST_CODE = 1005;
    ...
    public static void requestStoragePermissionsToConvertPicture(Activity activity) {
        activity.requestPermissions(
                new String[] {
                        Manifest.permission.READ_EXTERNAL_STORAGE,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE,
                },
                STORAGE_FOR_CONVERT_PICTURE_REQUEST_CODE);
    }

    public static void requestRecordAudioPermissionForVideo(Activity activity) {
        activity.requestPermissions(
                new String[] {
                        Manifest.permission.RECORD_AUDIO,
                },
                RECORD_AUDIO_FOR_VIDEO_REQUEST_CODE);
    }
}
