...
jint Java_com_dozingcatsoftware_eyeball_video_WebMEncoder_nativeStartEncoding(JNIEnv* env, jobject thiz, jstring javaPath, jint width, jint height, jfloat fps, jintArray jFrameDurations, jint deadline) {
...
jint Java_com_dozingcatsoftware_eyeball_video_WebMEncoder_nativeEncodeFrame(JNIEnv* env, jobject thiz, jintArray javaARGB) {
...
jint Java_com_dozingcatsoftware_eyeball_video_WebMEncoder_nativeCancelEncoding(JNIEnv* env, jobject thiz) {
